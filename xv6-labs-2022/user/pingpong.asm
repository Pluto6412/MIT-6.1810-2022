...
main(int argc, char *argv[])
{
  ...
  12:	88258593          	addi	a1,a1,-1918 # 890 <malloc+0xea>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	6a8080e7          	jalr	1704(ra) # 6c0 <fprintf>
    exit(1);
  20:	4505                	li	a0,1
  22:	00000097          	auipc	ra,0x0
  26:	352080e7          	jalr	850(ra) # 374 <exit>
  }

  pipe(p1);
  2a:	fe840513          	addi	a0,s0,-24
  2e:	00000097          	auipc	ra,0x0
  32:	356080e7          	jalr	854(ra) # 384 <pipe>
  pipe(p2);
  36:	fe040513          	addi	a0,s0,-32
  3a:	00000097          	auipc	ra,0x0
  3e:	34a080e7          	jalr	842(ra) # 384 <pipe>
  if(fork() == 0) {
  42:	00000097          	auipc	ra,0x0
  46:	32a080e7          	jalr	810(ra) # 36c <fork>
  4a:	ed31                	bnez	a0,a6 <main+0xa6>
    if(read(p1[0], s, 1)) {
  4c:	4605                	li	a2,1
  4e:	fd040593          	addi	a1,s0,-48
  52:	fe842503          	lw	a0,-24(s0)
  56:	00000097          	auipc	ra,0x0
  5a:	336080e7          	jalr	822(ra) # 38c <read>
  5e:	e511                	bnez	a0,6a <main+0x6a>
    if(read(p2[0], s, 1)) {
  ...
  66:	312080e7          	jalr	786(ra) # 374 <exit>
      fprintf(1, "%d: received ping\n", getpid());
  6a:	00000097          	auipc	ra,0x0
  6e:	38a080e7          	jalr	906(ra) # 3f4 <getpid>
  72:	862a                	mv	a2,a0
  74:	00001597          	auipc	a1,0x1
  78:	83458593          	addi	a1,a1,-1996 # 8a8 <malloc+0x102>
  7c:	4505                	li	a0,1
  7e:	00000097          	auipc	ra,0x0
  82:	642080e7          	jalr	1602(ra) # 6c0 <fprintf>
        write(p2[1], "p", 1);
  86:	4605                	li	a2,1
  88:	00001597          	auipc	a1,0x1
  8c:	83858593          	addi	a1,a1,-1992 # 8c0 <malloc+0x11a>
  90:	fe442503          	lw	a0,-28(s0)
  94:	00000097          	auipc	ra,0x0
  98:	300080e7          	jalr	768(ra) # 394 <write>
        exit(0);
  9c:	4501                	li	a0,0
  9e:	00000097          	auipc	ra,0x0
  a2:	2d6080e7          	jalr	726(ra) # 374 <exit>
    write(p1[1], "p", 1);
  a6:	4605                	li	a2,1
  a8:	00001597          	auipc	a1,0x1
  ac:	81858593          	addi	a1,a1,-2024 # 8c0 <malloc+0x11a>
  b0:	fec42503          	lw	a0,-20(s0)
  b4:	00000097          	auipc	ra,0x0
  b8:	2e0080e7          	jalr	736(ra) # 394 <write>
    if(read(p2[0], s, 1)) {
  bc:	4605                	li	a2,1
  be:	fd040593          	addi	a1,s0,-48
  c2:	fe042503          	lw	a0,-32(s0)
  c6:	00000097          	auipc	ra,0x0
  ca:	2c6080e7          	jalr	710(ra) # 38c <read>
  ce:	d949                	beqz	a0,60 <main+0x60>
      fprintf(1, "%d: received pong\n", getpid());
  d0:	00000097          	auipc	ra,0x0
  d4:	324080e7          	jalr	804(ra) # 3f4 <getpid>
  d8:	862a                	mv	a2,a0
  da:	00000597          	auipc	a1,0x0
  de:	7ee58593          	addi	a1,a1,2030 # 8c8 <malloc+0x122>
  e2:	4505                	li	a0,1
  e4:	00000097          	auipc	ra,0x0
  e8:	5dc080e7          	jalr	1500(ra) # 6c0 <fprintf>
  ec:	bf95                	j	60 <main+0x60>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45c:	4e850513          	addi	a0,a0,1256 # 940 <digits>
 460:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51c:	3d0c8c93          	addi	s9,s9,976 # 8e8 <malloc+0x142>
 ...
 52a:	41ab8b93          	addi	s7,s7,1050 # 940 <digits>
 ...
 650:	29498993          	addi	s3,s3,660 # 8e0 <malloc+0x13a>
        while(*s != 0){
 654:	85ee                	mv	a1,s11
