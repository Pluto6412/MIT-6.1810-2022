...
void prime(int inputF)
{
  ...
  16:	408080e7          	jalr	1032(ra) # 41a <read>
  1a:	e509                	bnez	a0,24 <prime+0x24>
  {
    exit(0);
  1c:	00000097          	auipc	ra,0x0
  20:	3e6080e7          	jalr	998(ra) # 402 <exit>
  }
  fprintf(1, "prime %d\n", base);
  24:	fdc42603          	lw	a2,-36(s0)
  28:	00001597          	auipc	a1,0x1
  2c:	8f858593          	addi	a1,a1,-1800 # 920 <malloc+0xec>
  30:	4505                	li	a0,1
  32:	00000097          	auipc	ra,0x0
  36:	71c080e7          	jalr	1820(ra) # 74e <fprintf>

  pipe(p1);
  3a:	fd040513          	addi	a0,s0,-48
  3e:	00000097          	auipc	ra,0x0
  42:	3d4080e7          	jalr	980(ra) # 412 <pipe>
  if(fork() == 0)
  46:	00000097          	auipc	ra,0x0
  4a:	3b4080e7          	jalr	948(ra) # 3fa <fork>
  4e:	ed09                	bnez	a0,68 <prime+0x68>
  {
    close(p1[1]);
  50:	fd442503          	lw	a0,-44(s0)
  54:	00000097          	auipc	ra,0x0
  58:	3d6080e7          	jalr	982(ra) # 42a <close>
    prime(p1[0]);
  5c:	fd042503          	lw	a0,-48(s0)
  60:	00000097          	auipc	ra,0x0
  64:	fa0080e7          	jalr	-96(ra) # 0 <prime>
    close(p1[0]);
    //exit(0);
  }
  else
  ...
  70:	3be080e7          	jalr	958(ra) # 42a <close>
    while(read(inputF, &tmp, sizeof(int)))
  74:	4611                	li	a2,4
  76:	fd840593          	addi	a1,s0,-40
  7a:	8526                	mv	a0,s1
  7c:	00000097          	auipc	ra,0x0
  80:	39e080e7          	jalr	926(ra) # 41a <read>
  84:	c115                	beqz	a0,a8 <prime+0xa8>
    {
      if(tmp % base != 0)
  86:	fd842783          	lw	a5,-40(s0)
  8a:	fdc42703          	lw	a4,-36(s0)
  8e:	02e7e7bb          	remw	a5,a5,a4
  92:	d3ed                	beqz	a5,74 <prime+0x74>
      {
        write(p1[1], &tmp, sizeof(int));
  94:	4611                	li	a2,4
  96:	fd840593          	addi	a1,s0,-40
  9a:	fd442503          	lw	a0,-44(s0)
  9e:	00000097          	auipc	ra,0x0
  a2:	384080e7          	jalr	900(ra) # 422 <write>
  a6:	b7f9                	j	74 <prime+0x74>
      }
    }
    close(p1[1]);
  a8:	fd442503          	lw	a0,-44(s0)
  ac:	00000097          	auipc	ra,0x0
  b0:	37e080e7          	jalr	894(ra) # 42a <close>
  }
  wait(0);
  b4:	4501                	li	a0,0
  b6:	00000097          	auipc	ra,0x0
  ba:	354080e7          	jalr	852(ra) # 40a <wait>
  exit(0);
  be:	4501                	li	a0,0
  c0:	00000097          	auipc	ra,0x0
  c4:	342080e7          	jalr	834(ra) # 402 <exit>
...
00000000000000c8 <main>:
{
  ...
  if (argc > 1)
  d2:	4785                	li	a5,1
  d4:	02a7d063          	bge	a5,a0,f4 <main+0x2c>
    fprintf(2, "Usage: primes\n");
  d8:	00001597          	auipc	a1,0x1
  dc:	85858593          	addi	a1,a1,-1960 # 930 <malloc+0xfc>
  e0:	4509                	li	a0,2
  e2:	00000097          	auipc	ra,0x0
  e6:	66c080e7          	jalr	1644(ra) # 74e <fprintf>
    exit(1);
  ea:	4505                	li	a0,1
  ec:	00000097          	auipc	ra,0x0
  f0:	316080e7          	jalr	790(ra) # 402 <exit>
  pipe(p);
  f4:	fd840513          	addi	a0,s0,-40
  f8:	00000097          	auipc	ra,0x0
  fc:	31a080e7          	jalr	794(ra) # 412 <pipe>
  if (fork() == 0)
 100:	00000097          	auipc	ra,0x0
 104:	2fa080e7          	jalr	762(ra) # 3fa <fork>
 108:	cd31                	beqz	a0,164 <main+0x9c>
    for (i = 2; i < 36; ++i)
 10a:	4789                	li	a5,2
 10c:	fcf42a23          	sw	a5,-44(s0)
 110:	02300493          	li	s1,35
      close(p[0]);
 114:	fd842503          	lw	a0,-40(s0)
 118:	00000097          	auipc	ra,0x0
 11c:	312080e7          	jalr	786(ra) # 42a <close>
      write(p[1], &i, sizeof(int));
 120:	4611                	li	a2,4
 122:	fd440593          	addi	a1,s0,-44
 126:	fdc42503          	lw	a0,-36(s0)
 12a:	00000097          	auipc	ra,0x0
 12e:	2f8080e7          	jalr	760(ra) # 422 <write>
    for (i = 2; i < 36; ++i)
 132:	fd442783          	lw	a5,-44(s0)
 136:	2785                	addiw	a5,a5,1
 138:	0007871b          	sext.w	a4,a5
 13c:	fcf42a23          	sw	a5,-44(s0)
 140:	fce4dae3          	bge	s1,a4,114 <main+0x4c>
    close(p[1]);
 144:	fdc42503          	lw	a0,-36(s0)
 148:	00000097          	auipc	ra,0x0
 14c:	2e2080e7          	jalr	738(ra) # 42a <close>
  wait(0);
 150:	4501                	li	a0,0
 152:	00000097          	auipc	ra,0x0
 156:	2b8080e7          	jalr	696(ra) # 40a <wait>
  exit(0);
 15a:	4501                	li	a0,0
 15c:	00000097          	auipc	ra,0x0
 160:	2a6080e7          	jalr	678(ra) # 402 <exit>
    close(p[1]);
 164:	fdc42503          	lw	a0,-36(s0)
 168:	00000097          	auipc	ra,0x0
 16c:	2c2080e7          	jalr	706(ra) # 42a <close>
    prime(p[0]);
 170:	fd842503          	lw	a0,-40(s0)
 174:	00000097          	auipc	ra,0x0
 178:	e8c080e7          	jalr	-372(ra) # 0 <prime>
...
_main()
{
 ...
 188:	f44080e7          	jalr	-188(ra) # c8 <main>
  exit(0);
 18c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ea:	4ba50513          	addi	a0,a0,1210 # 9a0 <digits>
 4ee:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5aa:	3a2c8c93          	addi	s9,s9,930 # 948 <malloc+0x114>
 ...
 5b8:	3ecb8b93          	addi	s7,s7,1004 # 9a0 <digits>
 ...
 6de:	26698993          	addi	s3,s3,614 # 940 <malloc+0x10c>
        while(*s != 0){
 6e2:	85ee                	mv	a1,s11
